...
for page, meta in pages_meta.items():
    ...
    if anchor not in content:
        print("WARNING: anchor not found in " + page + " (skipped)")
        continue

    if "og:title" in content:
        print(page + ": meta tags already present (skipped)")
        continue
...
<meta name="twitter:image" content=\"""" + site_url_base + "/" + og_image_path + """\">"""
    ...
    content = content.replace(anchor, new_tags, 1)
