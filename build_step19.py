...
old_hero = """    <p class="eyebrow">Software Developer &amp; Digital Growth Specialist</p>
...
new_hero = """    <h1 class="eyebrow">Software Developer &amp; Digital Growth Specialist</h1>
...
if old_hero in content:
    ...
    with open("index.html", "w") as file:
        file.write(content)
    print("index.html hero tags updated successfully")
else:
